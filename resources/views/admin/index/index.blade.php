...
@section('content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 col-md-3 col-lg-3">
                                        <div class="panel panel-default custom-user-panel">
                                            <img src="{{ asset('/admin/adminPanel/img/vahid.jpeg') }}" class="img-circle" alt="User Image" width="64" height="64">
                                            <div class="new-user-name">علی مصوری</div>
                                    ...
                                    <div class="col-sm-3 col-md-3 col-lg-3">
                                        <div class="panel panel-default custom-user-panel">
                                            <img src="{{ asset('/admin/adminPanel/img/avatar04.png') }}" class="img-circle" alt="User Image" width="64" height="64">
                                            <div class="new-user-name">علی مصوری</div>
                                            <div class="users-list-date">1396-10-14</div>
                                        </div>
                                    ...
                                    <div class="col-sm-3 col-md-3 col-lg-3">
                                        <div class="panel panel-default custom-user-panel">
                                            <img src="{{ asset('/admin/adminPanel/img/avatar.png') }}" class="img-circle" alt="User Image" width="64" height="64">
                                            <div class="new-user-name">علی مصوری</div>
                                            <div class="users-list-date">1396-10-14</div>
                                        </div>
                                    ...
                                    <div class="col-sm-3 col-md-3 col-lg-3">
                                        <div class="panel panel-default custom-user-panel">
                                            <img src="{{ asset('/admin/adminPanel/img/user7-128x128.jpg') }}" class="img-circle" alt="User Image" width="64" height="64">
                                            <div class="new-user-name">علی مصوری</div>
                                            <div class="users-list-date">1396-10-14</div>
                                        </div>
    ...
    margin: 6px;;">
                                <ul class="list-group admin-panel-comments" style="padding: 5px 10px;">
                                    <li><img src="{{ asset('/admin/adminPanel/img/avatar2.png') }}" class="img-thumbnail" width="36" height="36"> <a href="#">با سلام دوره اسکریپت نویس php چه زمانی...</a> </li>
                                    <li><img src="{{ asset('/admin/adminPanel/img/avatar3.png') }}" class="img-thumbnail" width="36" height="36"> <a href="#">با سلام دوره اسکریپت نویس php چه زمانی...</a> </li>
                                    <li><img src="{{ asset('/admin/adminPanel/img/avatar.png') }}" class="img-thumbnail" width="36" height="36"> <a href="#">با سلام دوره اسکریپت نویس php چه زمانی...</a> </li>
